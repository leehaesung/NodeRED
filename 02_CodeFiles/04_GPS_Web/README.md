...
* Displaying Temperatuer & Humidity with GPS Data on Google map from Python GPS Simulator

![GPSWeb_TempHumLatLon.png](https://github.com/leehaesung/NodeRED/blob/master/02_CodeFiles/04_GPS_Web/GPSWeb_TempHumLatLon.png)
![GPSWeb_TempHumLatLon_output01.png](https://github.com/leehaesung/NodeRED/blob/master/02_CodeFiles/04_GPS_Web/GPSWeb_TempHumLatLon_output01.png)

```````````````````````````````````````````````````
[{"id":"9f8e3c8.b3a57c","type":"http in","z":"e480804b.a7084","name":"/IoTDeviceLocation","url":"/IoTDeviceLocation","method":"get","swaggerDoc":"","x":118.5714340209961,"y":1491.4285888671875,"wires":[["a43ec5de.878ed8"]]},{"id":"979ca38b.bc437","type":"function","z":"e480804b.a7084","name":"setHTTPheader","func":"// If sending JSON data the content type is:\n//msg.headers={\"Content-Type\":\"application/json\"};\n\n// For HTML use the content type line below:\nmsg.headers={\"Content-Type\":\"text/html\"};\nreturn msg;","outputs":1,"noerr":0,"x":529.7143325805664,"y":1673.714204788208,"wires":[["83314338.5adbc"]]},{"id":"21a506b9.260b7a","type":"debug","z":"e480804b.a7084","name":"","active":true,"console":"false","complete":"false","x":557.1428985595703,"y":1614.9999723434448,"wires":[]},{"id":"d7ec8c8f.8a10d","type":"debug","z":"e480804b.a7084","name":"","active":true,"console":"false","complete":"false","x":558.5714340209961,"y":1345.71426486969,"wires":[]},{"id":"918c33b5.38116","type":"template","z":"e480804b.a7084","name":"IoT device on Googlmap","field":"payload","fieldType":"msg","format":"handlebars","syntax":"mustache","template":"<!DOCTYPE html>\n<html>\n  <head>\n    <style>\n       #map {\n        height: 400px;\n        width: 100%;\n       }\n    </style>\n  </head>\n  <body>\n    <h1>Where is my IoT device?</h1>\n    <h2>(1) Temperature: {{payload.d.temperature}} °C </h2>\n    <h2>(2) Humidity: {{payload.d.humidity}} % </h2>\n    <h2>(3) Location: (Latitude: {{payload.d.location.latitude}}, Longitude: {{payload.d.location.longitude}})</h2>\n    <div id=\"map\"></div>\n    <script>\n      function initMap() {\n        var IoTDevice = {lat: {{payload.d.location.latitude}},lng: {{payload.d.location.longitude}} };\n        var map = new google.maps.Map(document.getElementById('map'), {\n          zoom: 18,\n          center: IoTDevice\n        });\n        var marker = new google.maps.Marker({\n          position: IoTDevice,\n          map: map\n        });\n      }\n    </script>\n    <script async defer\n        src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyDhA8Lb-e_JvMYmEh2RLA3rFBeEllQYsFI&callback=initMap\">\n    </script>\n  </body>\n</html>","x":347.1428680419922,"y":1615.5714015960693,"wires":[["979ca38b.bc437","21a506b9.260b7a"]]},{"id":"a43ec5de.878ed8","type":"function","z":"e480804b.a7084","name":"Retrieving Gps Data","func":"var temperature = {payload: JSON.stringify(context.global.d.temperature)};\nvar humidity = {payload: JSON.stringify(context.global.d.humidity)};\nvar latitude = {payload: JSON.stringify(context.global.d.location.latitude)};\nvar longitude = {payload: JSON.stringify(context.global.d.location.longitude)};\n\nmsg.payload = {'d':{'temperature':temperature.payload,\n                    'humidity':humidity.payload,\n                    'location':\n                                {\n                                 'latitude':latitude.payload,\n                                 'longitude':longitude.payload\n                                }\n                   }\n              };\n\nreturn msg;","outputs":1,"noerr":0,"x":239.14283752441406,"y":1551.428544998169,"wires":[["918c33b5.38116","c0ca33d9.58bab"]]},{"id":"c0ca33d9.58bab","type":"debug","z":"e480804b.a7084","name":"","active":true,"console":"false","complete":"false","x":453.85716247558594,"y":1552.5714025497437,"wires":[]},{"id":"83314338.5adbc","type":"http response","z":"e480804b.a7084","name":"","x":699.2857666015625,"y":1673.7145013809204,"wires":[]},{"id":"c12865fe.6ad698","type":"function","z":"e480804b.a7084","name":"Gathering GPS Data","func":"var d = msg.payload.d;\ncontext.global.d = d;\nreturn msg;\n","outputs":1,"noerr":0,"x":348.5714340209961,"y":1345.71426486969,"wires":[["d7ec8c8f.8a10d"]]},{"id":"61f1765.7f79d88","type":"ibmiot in","z":"e480804b.a7084","authentication":"boundService","apiKey":"","inputType":"evt","deviceId":"iotgateway001","applicationId":"","deviceType":"+","eventType":"+","commandType":"","format":"json","name":"iotgateway001","service":"registered","allDevices":"","allApplications":"","allDeviceTypes":true,"allEvents":true,"allCommands":"","allFormats":"","qos":0,"x":118.5714340209961,"y":1345.71426486969,"wires":[["c12865fe.6ad698","93dc3761.37d9a8"]]},{"id":"93dc3761.37d9a8","type":"debug","z":"e480804b.a7084","name":"","active":true,"console":"false","complete":"false","x":305.7142868041992,"y":1392.8570917844772,"wires":[]},{"id":"934aca15.d073c8","type":"comment","z":"e480804b.a7084","name":"From GPS Sensor to IBM Cloud","info":"","x":163.5714340209961,"y":1299.71426486969,"wires":[]},{"id":"d204b2b4.7ba7c","type":"comment","z":"e480804b.a7084","name":"My IoT Device Location On Google Map","info":"","x":188.5714340209961,"y":1451.4285888671875,"wires":[]},{"id":"581c78e.a1fad88","type":"comment","z":"e480804b.a7084","name":"Measureing Temperature & Humidity @ Latitude & Longitude","info":"","x":247.5446319580078,"y":1252.6042098999023,"wires":[]}]
```````````````````````````````````````````````````
...
try:
    gatewayOptions = {"org": "5gj0c6", "type": "iotgateway001", "id": "iotgateway001", "auth-method": "token", "auth-token": "l24482448"}
    gatewayCli = ibmiotf.gateway.Client(gatewayOptions)
    gatewayCli.connect()

    while True:
        myData = {'d':{'temperature':21.12,'humidity':29,'location':{'latitude':-33.874299,'longitude':151.228458}}}
...
(2) Retrieving Gps Data
```````````````````````````````````````````````````
var temperature = {payload: JSON.stringify(context.global.d.temperature)};
var humidity = {payload: JSON.stringify(context.global.d.humidity)};
var latitude = {payload: JSON.stringify(context.global.d.location.latitude)};
var longitude = {payload: JSON.stringify(context.global.d.location.longitude)};
